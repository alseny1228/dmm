        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Modification d'un type d'operation</h3>
                </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <?php if(isset($_GET) AND !empty($_GET)):?>
                                         <?php foreach ($type1 as $typ):?>
                                            <input type="text" hidden value="<?=$typ->TOID;?>" name="tid" class="form-control" placeholder="Saisir le type du vehicule" required>
                                            <input type="text" value="<?=$typ->typeoperation;?>" name="type" class="form-control" placeholder="Saisir le type du vehicule" required>
                                        <?php endforeach;?>
                                        <?php endif;?>
