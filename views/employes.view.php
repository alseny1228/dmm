                            ...
                            <form class="needs-validation" method="POST" action="" novalidate>
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <?php global $nom;?>
                                        <input type="text" value="<?=$nom;?>" name="nom" class="form-control" placeholder="Nom" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Prenom</label>
                                        <?php global $prenom;?>
                                        <input type="text" name="prenom"  value="<?=$prenom;?>" class="form-control" placeholder="Prenom" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Adresse</label>
                                        <?php global $adresse;?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="telephone"  value="<?=$telephone;?>" class="form-control" placeholder="Saisir le Numéro de l'employé" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Sexe</label>
                                        <?php global $sexe;?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="dateembauche"  value="<?=$dateembauche;?>" class="form-control" placeholder="Date d'embauche" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Salaire</label>
                                        <?php global $salaire;?>
                                        <input type="text" name="salaire"  value="<?=$salaire;?>" class="form-control" placeholder="Salaire" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Identifiant</label>
                                        <?php global $identifiant;?>
                                        <input type="text" name="identifiant"  value="<?=$identifiant;?>" class="form-control" placeholder="Salaire" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Email</label>
                                        <?php global $email;?>
                                        <input type="text" name="email"  value="<?=$email;?>" class="form-control" placeholder="Saisir l'email de l'employé" required>
                                    </div>
                                    <input value="Valider" class="btn btn-primary" type="submit">
